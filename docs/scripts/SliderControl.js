L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:hsl(138, 54%, 42%, .4); text-align:center; color:azure; border-radius:5px;"></div></div>');
